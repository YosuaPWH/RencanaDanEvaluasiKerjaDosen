<button type="button" onclick="openModal(true)" class="p-2 text-white rounded bg-green-500 font-medium hover:bg-green-600 mb-2">
        ...
        <div  class="relative p-4 bg-whitety rounded-lg shadow sm:p-5">
            ...
            <form action="/rencana-kerja/{{ $jns_table }}/tambah-data" method="POST">
                ...
                <div class="flex justify-end gap-2 mt-4">
                    ...
                    <button type="button" onclick="openModal(false)" class="hover:bg-red-600 text-red-600 font-semibold hover:text-white py-2 px-4 outline-1 outline border-red-600 rounded">Batal</button>
                </div>
            </form>
        </div>
    </div>
