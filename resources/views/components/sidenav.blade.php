<div class="py-5 px-1">
    <ul class="space-y-2 list-unstyled p-2">
        <li>
            <a href="#" class="flex rounded-lg text-white text-decoration-none hover:bg-blue-400 p-2 w-full">
        ...
        <li>
            <button class="flex rounded-lg hover:bg-blue-400 p-2 w-full">
        ...
        <li>
            <a href="/user/logout" class="text-decoration-none text-white">
                <button class="flex rounded-lg hover:bg-blue-400 p-2 w-full" type="submit">
                    <svg aria-hidden="true" class="flex-shrink-0 w-6 h-6 text-gray-400  group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M4 4a2 2 0 012-2h4.586A2 2 0 0112 2.586L15.414 6A2 2 0 0116 7.414V16a2 2 0 01-2 2H6a2 2 0 01-2-2V4zm2 6a1 1 0 011-1h6a1 1 0 110 2H7a1 1 0 01-1-1zm1 3a1 1 0 100 2h6a1 1 0 100-2H7z" clip-rule="evenodd"></path></svg>
                    <span>Log out</span>                
                </button>
            </a>
        </li>
