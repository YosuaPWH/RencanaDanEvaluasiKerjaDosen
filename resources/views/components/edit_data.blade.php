    ...
    <div id="modal" class=" transform -translate-y-full  scale-150  relative w-full max-w-2xl rounded-lg h-full md:h-auto bg-white  duration-300">
        ...
        <div  class="relative p-4 bg-whitety rounded-lg shadow sm:p-5">
            ...
            <form id="edit-form" action="{{ $pelaksanaan }}/edit-data" method="POST">
                ...
                <div>
                    <div class="mb-4">
                        <input type="text" name="modal_input_pelaksanaan" id="modal-input-nama-tabel" class="form-control" disabled>
                    </div>
                    <div class="mb-2">
                ...
                <div class="flex justify-end gap-2 mt-4">
                    ...
                    <button type="button" onclick="edit(false)" class="hover:bg-red-600 text-red-600 font-semibold hover:text-white py-2 px-4 outline-1 outline border-red-600 rounded">Batal</button>
                </div>
            </form>
        </div>
    </div>
        ...
        $('.btn-edit').on('click', function() {
            ...
            $.ajax({
                ...
                success: function(res) { 
                    ...
                    $("#modal-input-beban-tugas").val(res.beban_tugas*1);
