...
<div>
    ...
    <div class="bg-white rounded-lg p-2 border mb-2">
        ...
        <div class="border rounded-lg overflow-auto" id="bagianB">
            <table class="w-full ">
                <thead>
                    <tr class="bg-theme-4">
                        <th class="p-2 border-r-2 w-1">No</th>
    ...
    <div class="bg-white rounded-lg p-2 border mb-2">
        ...
        <div class="border rounded-lg overflow-auto" id="bagianC">
            <table class="w-full ">
                <thead>
                    <tr class="bg-theme-4">
                        <th class="p-2 border-r-2 w-1">No</th>
    ...
    <div class="bg-white rounded-lg p-2 border mb-2">
        ...
        <div class="border rounded-lg overflow-auto" id="bagianD">
            <table class="w-full ">
                <thead>
                    <tr class="bg-theme-4">
                        <th class="p-2 border-r-2 w-1">No</th>
    ...
    <div class="bg-white rounded-lg p-2 border mb-2">
        ...
        <div class="border rounded-lg overflow-auto" id="bagianE">
            <table class="w-full ">
                <thead>
                    <tr class="bg-theme-4">
                        <th class="p-2 border-r-2 w-1">No</th>
    ...
    <div class="bg-white rounded-lg p-2 border mb-2">
        ...
        <div class="border rounded-lg overflow-auto" id="bagianF">
            <table class="w-full ">
                <thead>
                    <tr class="bg-theme-4">
                        <th class="p-2 border-r-2 w-1">No</th>
    ...
    <div class="bg-white rounded-lg p-2 border mb-2">
        ...
        <div class="border rounded-lg overflow-auto" id="bagianG">
            <table class="w-full ">
                <thead>
                    <tr class="bg-theme-4">
                        <th class="p-2 border-r-2 w-1">No</th>
    ...
    <div class="bg-white rounded-lg p-2 border mb-2">
        ...
        <div class="border rounded-lg overflow-auto" id="bagianH">
            <table class="w-full ">
                <thead>
                    <tr class="bg-theme-4">
                        <th class="p-2 border-r-2 w-1">No</th>
    ...
    <div class="bg-white rounded-lg p-2 border mb-2">
        ...
        <div class="border rounded-lg overflow-auto" id="bagianI">
            <table class="w-full ">
                <thead>
                    <tr class="bg-theme-4">
                        <th class="p-2 border-r-2 w-1">No</th>
    ...
    <div class="bg-white rounded-lg p-2 border mb-2">
        ...
        <div class="border rounded-lg overflow-auto" id="bagianJ">
            <table class="w-full ">
                <thead>
                    <tr class="bg-theme-4">
                        <th class="p-2 border-r-2 w-1">No</th>
    ...
    <div class="bg-white rounded-lg p-2 border mb-2">
        ...
        <div class="border rounded-lg overflow-auto" id="bagianK">
            <table class="w-full ">
                <thead>
                    <tr class="bg-theme-4">
                        <th class="p-2 border-r-2 w-1">No</th>
    ...
    <div class="bg-white rounded-lg p-2 border mb-2">
        ...
        <div class="border rounded-lg overflow-auto" id="bagianL">
            <table class="w-full ">
                <thead>
                    <tr class="bg-theme-4">
                        <th class="p-2 border-r-2 w-1">No</th>
    ...
    <div class="bg-white rounded-lg p-2 border mb-2">
        ...
        <div class="border rounded-lg overflow-auto" id="bagianM">
            <table class="w-full ">
                <thead>
                    <tr class="bg-theme-4">
                        <th class="p-2 border-r-2 w-1">No</th>
    ...
    <div class="bg-white rounded-lg p-2 border mb-2">
        ...
        <div class="border rounded-lg overflow-auto" id="bagianN">
            <table class="w-full ">
                <thead>
                    <tr class="bg-theme-4">
                        <th class="p-2 border-r-2 w-1">No</th>
